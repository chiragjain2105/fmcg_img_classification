...
%loading data
[training_data_1,m1]=process_data('C:\Users\chirag\Desktop\matlabfiles\Assignment-2\training\Defective',20,20,3);
y1=ones(m1,1);
x11=size(y1);
x1=length(y1);
[training_data_2,m2]=process_data('C:\Users\chirag\Desktop\matlabfiles\Assignment-2\training\Non-Defective',20,20,3);
y2=zeros(m2,1);
x22=size(y2);
x2=length(y2);

[training_data_3,m3]=process_data('C:\Users\chirag\Desktop\def',20,20,3);
[training_data_4,m4]=process_data('C:\Users\chirag\Desktop\notdef',20,20,3);
y3=ones(m3,1);
y4=zeros(m4,1);
...
for i=1:1:length(lambda)
    ...
    l=lambda(i);
    [theta, cost] = fminunc(@(t)(costFunctionreg(t, X, y,l)), initial_theta, options);
...
[test_data_1 s1]=process_data('C:\Users\chirag\Desktop\matlabfiles\Assignment-2\test\defective',20,20,3)
y_act1=ones(s1,1);
test_data_2=[ones(s1,1) test_data_1]
for i=1:1:s1
   a1(i)=predict(theta,test_data_2(i,:))
end
[test_data_3 s2]=process_data('C:\Users\chirag\Desktop\matlabfiles\Assignment-2\test\not defective',20,20,3)
Y_act2=zeros(s2,1);
